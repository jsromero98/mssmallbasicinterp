...
public class MymssmallbasicLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DIV", "ADD", "SUB", "OBJKEYWORD", "LINE_COMMENT", "WS", "AND", "OR", 
			"EQ", "ROP", "NEQ", "GTE", "LTE", "GT", "LT", "LPAREN", "RPAREN", "LBRACK", 
			"RBRACK", "INT", "DOUBLE", "ID", "STRING", "NEWLINE"
		};
	}
	...
	public MymssmallbasicLexer(CharStream input) {
		super(input);
